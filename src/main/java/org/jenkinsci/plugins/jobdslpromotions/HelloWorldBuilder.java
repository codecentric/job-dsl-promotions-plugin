package org.jenkinsci.plugins.jobdslpromotions;
...
public class HelloWorldBuilder extends Builder {
	...
	public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
		 ...
		 *         <p>
		 *         Note that returning {@link FormValidation#error(String)} does not prevent the form from being saved.
		 *         It just means that a message will be displayed to the user.
		 */
